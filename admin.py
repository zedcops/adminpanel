...
try:
    print "\t###################################################################"
    print "\t## created by : zedcops ############### created by : zedcops     ##"
    print "\t###################################################################"
    print "\t############                                             ##########"
    print "\t############     @@@@    @@@@    @@    @@  @  @@    @    ##########"
    print "\t############    @    @   @   @   @ @  @ @  @  @ @   @    ##########"
...
'adm/index.brf','adm.brf','affiliate.brf','adm_auth.brf','memberadmin.brf','administratorlogin.brf']
    ...
    try:
        ...
        raw_input("\t [!] Error occured, Server offline or invalid URL")
        exit()
    ...
    if code==1:
        ...
        raw_input("Over; Press Enter to Exit")
    ...
    print "\n\t[!] Cancelled; Error . Check internet settings"
